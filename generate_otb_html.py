...
ACCOUNTS = [
    ...
    ("David Parrish", "Benjamin Short", "ENGIE Impact - MA", "0013r00002EFLhiAAH", "2026-02-01"),
    ("Matthew Loewel", "Benjamin Short", "Archera", "0013r00002QbYmeAAF", "2026-02-01"),
    ("Alessandra Maahs", "Benjamin Short", "Navex Global Inc.", "0010Z00001tFJ7nQAG", "2026-02-01"),
    ("Matthew Loewel", "Benjamin Short", "SanMar Corporation", "0013100001coYXQAA2", "2026-02-01"),
    ...
    ("Chad Sagmoen", "Stephen Kalkbrenner", "Magnum Transaction Sub, LLC d/b/a Lyric.", "001Do00000LaFWDIA3", "2026-04-01"),
    ...
    ("Ian Parsons", "Courtney Bencze", "Pinterest", "001i000001RkgDwAAJ", "2026-04-01"),
    ("Ian Parsons", "Courtney Bencze", "RightRev", "0013r00002XXeENAA1", "2026-04-01"),
    ("Ian Towle", "Courtney Bencze", "Luma Health", "0013r00002UrHKYAA3", "2026-04-01"),
    ("Ian Towle", "Courtney Bencze", "Twin Health", "0013r00002EF543AAD", "2026-04-01"),
    ("Riley Babcock", "Courtney Bencze", "ChargePoint", "0013100001sbSBQAA2", "2026-04-01"),
    ("Riley Babcock", "Courtney Bencze", "Theomai", "0013r00002dPkQTAA0", "2026-04-01"),
]
...
ACTIVITY = {
    ...
    ("0013100001rsDOuAAM", "alessandra.maahs@snowflake.com"):  (1, 0, 0, 0.0),
    ...
    ("0010Z00002D3dOqQAJ", "andrew.keefer@snowflake.com"):     (72, 7, 65, 13.5),
    ("0013100001e3Q8uAAE", "andrew.keefer@snowflake.com"):     (62, 29, 33, 23.0),
    ("0013r00002YMhtnAAD", "arjun.mazumdar@snowflake.com"):    (1, 0, 0, 0.0),
    ("0013100001bn326AAA", "chad.sagmoen@snowflake.com"):      (1, 0, 0, 0.0),
    ("0013100001oMYuCAAW", "chad.sagmoen@snowflake.com"):      (1, 0, 0, 0.0),
    ("0013r00002K9dB2AAJ", "chad.sagmoen@snowflake.com"):      (1, 0, 0, 0.0),
    ("0013r00002Pa9dVAAR", "chad.sagmoen@snowflake.com"):      (1, 0, 0, 0.0),
    ("001Do00000LaFWDIA3", "chad.sagmoen@snowflake.com"):      (1, 0, 0, 0.0),
    ("0010Z00001xw65XQAQ", "danny.king@snowflake.com"):        (1, 1, 0, 0.5),
    ("0013100001gXxPTAA0", "danny.king@snowflake.com"):        (1, 0, 0, 0.0),
    ...
    ("0013r00002EEWF4AAP", "david.parrish@snowflake.com"):     (1, 0, 0, 0.0),
    ("0013r00002EFLhiAAH", "david.parrish@snowflake.com"):     (21, 2, 19, 1.0),
    ("0010Z000025Ao5UQAS", "dj.kline@snowflake.com"):          (116, 23, 93, 21.75),
    ("0013100001nnZZjAAM", "dj.kline@snowflake.com"):          (1, 0, 0, 0.0),
    ("0013r00002EEIpOAAX", "dj.kline@snowflake.com"):          (2, 2, 0, 1.0),
    ("0010Z0000259NHnQAM", "eric.breuninger@snowflake.com"):   (1, 0, 0, 0.0),
    ("0013100001qzIBSAA2", "eric.breuninger@snowflake.com"):   (4, 1, 3, 0.5),
    ("0013r00002EFsqEAAT", "eric.breuninger@snowflake.com"):   (1, 0, 0, 0.0),
    ("0013r00002XXeENAA1", "ian.parsons@snowflake.com"):       (1, 0, 0, 0.0),
    ("001i000001RkgDwAAJ", "ian.parsons@snowflake.com"):       (1, 0, 0, 0.0),
    ("0013r00002EF543AAD", "ian.towle@snowflake.com"):         (1, 0, 0, 0.0),
    ("0013r00002UrHKYAA3", "ian.towle@snowflake.com"):         (1, 0, 0, 0.0),
    ...
    ("0013100001coYXQAA2", "matthew.loewel@snowflake.com"):    (1, 0, 0, 0.0),
    ("0013r00002QbYmeAAF", "matthew.loewel@snowflake.com"):    (1, 0, 0, 0.0),
    ("0013r00002UrHHtAAN", "nicholas.ahearn@snowflake.com"):   (31, 12, 19, 6.4),
    ("0013r00002XWxb2AAD", "noah.mahr@snowflake.com"):         (4, 1, 3, 0.75),
    ("0010Z00001tFUG0QAO", "noy.bar@snowflake.com"):           (1, 0, 1, 0.0),
    ("0010Z0000297szGQAQ", "noy.bar@snowflake.com"):           (8, 2, 6, 1.0),
    ("0013100001qyDleAAE", "noy.bar@snowflake.com"):           (8, 7, 1, 3.5),
    ("0013r00002EEDzCAAX", "noy.bar@snowflake.com"):           (8, 2, 6, 1.0),
    ("0013r00002IJS7WAAX", "noy.bar@snowflake.com"):           (1, 0, 0, 0.0),
    ("0013r00002K9hK7AAJ", "omar.ramahi@snowflake.com"):       (6, 5, 1, 3.25),
    ("0013100001sbSBQAA2", "riley.babcock@snowflake.com"):     (1, 0, 0, 0.0),
    ("0013r00002dPkQTAA0", "riley.babcock@snowflake.com"):     (1, 0, 0, 0.0),
    ("0010Z000026n9KfQAI", "sawyer.ramsey@snowflake.com"):     (1, 0, 0, 0.0),
    ("0010Z0000295KoFQAU", "sawyer.ramsey@snowflake.com"):     (1, 0, 0, 0.0),
    ("0013100001nnXwhAAE", "sawyer.ramsey@snowflake.com"):     (1, 0, 1, 0.0),
    ("0013100001qwUTcAAM", "sawyer.ramsey@snowflake.com"):     (15, 3, 12, 1.75),
    ("0013100001kbbJQAAY", "shane.rinkus@snowflake.com"):      (26, 4, 22, 2.25),
}
...
RR_DATA = {
    "0010Z00001tFGoKQAW": (203929,   "Jan 2026", 3545125,    "Mar 2026"),
    "0010Z00001tFJ7nQAG": (210088,   "Jan 2026", 4579128,    "Mar 2026"),
    "0010Z00001tFUG0QAO": (1281716,  "Jan 2026", 20080301,   "Mar 2026"),
    "0010Z00001uZXGYQA4": (737415,   "Mar 2026", 12025686,   "Mar 2026"),
    "0010Z00001xw65XQAQ": (325517,   "Jan 2026", 4173205,    "Mar 2026"),
    "0010Z00001xwkPDQAY": (281623,   "Jan 2026", 4428548,    "Mar 2026"),
    "0010Z0000259NHnQAM": (1459904,  "Mar 2026", 15132834,   "Mar 2026"),
    "0010Z000025Ao5UQAS": (1710213,  "Jan 2026", 30256180,   "Mar 2026"),
    "0010Z000026n9KfQAI": (367950,   "Jan 2026", 6217777,    "Mar 2026"),
    "0010Z0000295KoFQAU": (382015,   "Jan 2026", 9909150,    "Mar 2026"),
    "0010Z0000297szGQAQ": (800661,   "Jan 2026", 13065465,   "Mar 2026"),
    "0010Z00002D3dOqQAJ": (789180,   "Jan 2026", 11835210,   "Mar 2026"),
    "0013100001bn326AAA": (550478,   "Mar 2026", 7618585,    "Mar 2026"),
    "0013100001coYXQAA2": (112253,   "Jan 2026", 1344018,    "Mar 2026"),
    "0013100001dGmrNAAS": (183594,   "Jan 2026", 2533646,    "Mar 2026"),
    "0013100001e3Q8uAAE": (7338322,  "Jan 2026", 113271687,  "Mar 2026"),
    "0013100001gXxPTAA0": (183345,   "Jan 2026", 3321787,    "Mar 2026"),
    "0013100001gxIlNAAU": (304886,   "Mar 2026", 4794275,    "Mar 2026"),
    "0013100001kbbJQAAY": (1105993,  "Jan 2026", 14860566,   "Mar 2026"),
    "0013100001nnXwhAAE": (216070,   "Jan 2026", 3330665,    "Mar 2026"),
    "0013100001nnZZjAAM": (649165,   "Jan 2026", 9758911,    "Mar 2026"),
    "0013100001nncprAAA": (253888,   "Jan 2026", 4540626,    "Mar 2026"),
    "0013100001oMYuCAAW": (583369,   "Mar 2026", 10193269,   "Mar 2026"),
    "0013100001qwUTcAAM": (149993,   "Jan 2026", 2913550,    "Mar 2026"),
    "0013100001qyDleAAE": (692911,   "Jan 2026", 14577111,   "Mar 2026"),
    "0013100001qzIBSAA2": (1051531,  "Mar 2026", 9990649,    "Mar 2026"),
    "0013100001rsDOuAAM": (683535,   "Jan 2026", 6674662,    "Mar 2026"),
    "0013100001rvJiDAAU": (156717,   "Jan 2026", 2494176,    "Mar 2026"),
    "0013100001sbSBQAA2": (639895,   "Mar 2026", 7250082,    "Mar 2026"),
    "0013r00002EEDzCAAX": (711632,   "Jan 2026", 13174753,   "Mar 2026"),
    "0013r00002EEIpOAAX": (911943,   "Jan 2026", 12646088,   "Mar 2026"),
    "0013r00002EEWF4AAP": (122139,   "Jan 2026", 2001546,    "Mar 2026"),
    "0013r00002EF543AAD": (390875,   "Mar 2026", 5407278,    "Mar 2026"),
    "0013r00002EFLhiAAH": (218560,   "Jan 2026", 2821766,    "Mar 2026"),
    "0013r00002EFsqEAAT": (495599,   "Mar 2026", 6833923,    "Mar 2026"),
    "0013r00002IJS7WAAX": (3038293,  "Jan 2026", 39499484,   "Mar 2026"),
    "0013r00002K9dB2AAJ": (841402,   "Mar 2026", 12099127,   "Mar 2026"),
    "0013r00002K9hK7AAJ": (944826,   "Jan 2026", 13711144,   "Mar 2026"),
    "0013r00002Pa9dVAAR": (421278,   "Mar 2026", 6386057,    "Mar 2026"),
    "0013r00002QbYmeAAF": (310312,   "Jan 2026", 3955123,    "Mar 2026"),
    "0013r00002QcPGJAA3": (494244,   "Jan 2026", 8353532,    "Mar 2026"),
    "0013r00002UrHHtAAN": (1395270,  "Jan 2026", 26183118,   "Mar 2026"),
    "0013r00002UrHKYAA3": (560048,   "Mar 2026", 7725398,    "Mar 2026"),
    "0013r00002XWxb2AAD": (42797,    "Mar 2026", 543975,     "Mar 2026"),
    "0013r00002XXeENAA1": (627070,   "Mar 2026", 7213936,    "Mar 2026"),
    "0013r00002YMhtnAAD": (1029477,  "Mar 2026", 10319297,   "Mar 2026"),
    "0013r00002dPkQTAA0": (1017849,  "Mar 2026", 9477958,    "Mar 2026"),
    "001Do00000LaFWDIA3": (976141,   "Mar 2026", 10319678,   "Mar 2026"),
    "001i000001R8a5VAAR": (169413,   "Jan 2026", 3092063,    "Mar 2026"),
    "001i000001RkgDwAAJ": (448282,   "Mar 2026", 6402237,    "Mar 2026"),
}
